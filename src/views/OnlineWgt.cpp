...
//	ButtonPanel *connectingErr = new ButtonPanel("Не удалсь подключится к серверу!", 
//												 {"Ок"}, getPanelPixmaps(), MULT, this);
...
//	connect(this, &OnlineWgt::cancelConnectingSignal, connectingErr, &ButtonPanel::deleteLater);
